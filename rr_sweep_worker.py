...
"""Single R:R backtest worker with trailing disabled (TP-or-SL only)."""
import json
import os
import sys
...
bt.USE_OPEN_RR = False  # RR sweep tests fixed-TP ratios
bt.RR_RATIO = ratio
...
name = f"_res_rr_{label}_{int(ratio):d}.json"
